...
struct hash_table {
  ...
  // table points to dynamic array of hash_node pointers (read comments for htable above). 
  // It should be initialized to a dynamic array of pointers to hash_node structs. 
  // Those pointers should all initially be NULL.
